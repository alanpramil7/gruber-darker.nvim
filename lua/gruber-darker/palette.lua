...
M = {
	...
	green = Color.new(0x82aaff),
	yellow = Color.new(0x7aa2f7),
	brown = Color.new(0x5f7e97),
	light_blue = Color.new(0x89dceb),
	blue = Color.new(0x5b8cff),
	gold = Color.new(0x74c7ec),
