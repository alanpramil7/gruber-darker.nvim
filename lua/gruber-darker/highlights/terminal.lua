...
function M.setup()
	-- terminal colors adapted from Emacs `term-color-*` faces
	vim.g.terminal_color_0 = c["bg+3"]:to_string()
	vim.g.terminal_color_8 = c["bg+4"]:to_string()
	...
	vim.g.terminal_color_6 = c.quartz:to_string()
	vim.g.terminal_color_14 = c.quartz:to_string()

	vim.g.terminal_color_7 = c.fg:to_string()
	vim.g.terminal_color_15 = c.white:to_string()

	vim.g.terminal_color_background = c.bg:to_string()
	vim.g.terminal_color_foreground = c.fg:to_string()
end
